...
{
    {AUDIO_APP_VOICE_CALL, AUDIO_APP_VOICE_CALL_WB, AUDIO_APP_MUSIC, AUDIO_APP_RECORDING, AUDIO_APP_FM, AUDIO_APP_RECORDING_GVS, AUDIO_APP_VOIP, AUDIO_APP_VOIP_INCOMM, AUDIO_APP_RECORDING_NB},  //BRCM_STATE_NORMAL
    {AUDIO_APP_VOICE_CALL, AUDIO_APP_VOICE_CALL_WB, -1, -1, -1, -1, -1, -1, -1}, //BRCM_STATE_INCALL
    {AUDIO_APP_VOICE_CALL, AUDIO_APP_VOICE_CALL_WB, AUDIO_APP_FM, AUDIO_APP_RECORDING, AUDIO_APP_FM, AUDIO_APP_RECORDING_GVS, AUDIO_APP_VOIP, AUDIO_APP_VOIP_INCOMM, AUDIO_APP_RECORDING_NB},  //BRCM_STATE_FM
    {AUDIO_APP_VOICE_CALL, AUDIO_APP_VOICE_CALL_WB, -1, AUDIO_APP_RECORDING, -1, AUDIO_APP_RECORDING_GVS, AUDIO_APP_VOIP, AUDIO_APP_VOIP_INCOMM, AUDIO_APP_RECORDING_NB}  //BRCM_STATE_RECORD
};
