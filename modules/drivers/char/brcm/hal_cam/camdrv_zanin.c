...
#include "camacq_sr200pc20.h"//BYKIM_DTP
...
// -------Enable Clock to Cameras @ Main clock speed
    {GPIO_CNTRL, CAM_STBY,   GPIO_SetHigh},
    {PAUSE, 2, Nop_Cmd},
    {MCLK_CNTRL, SENSOR_CLOCK_SPEED,    CLK_TurnOn},
    {GPIO_CNTRL, CAM_STBY,   GPIO_SetLow},
    {PAUSE, 30, Nop_Cmd},
// -------Raise PwrDn to ISP
// -------Raise Reset to ISP
    {GPIO_CNTRL, CAM_2M_RST,   GPIO_SetHigh}
    //{PAUSE,16, Nop_Cmd},
...
static CamSensorIntfCntrl_st_t CamPowerOffSeq[] = {
	// -------Lower Reset to ISP    
    {GPIO_CNTRL, CAM_2M_RST,    GPIO_SetLow},
        {GPIO_CNTRL, CAM_STBY,   GPIO_SetHigh},
    {PAUSE, 5, Nop_Cmd},
...
static HAL_CAM_Result_en_t Init_zanin_sensor(CamSensorSelect_t sensor)
{
	HAL_CAM_Result_en_t result = HAL_CAM_SUCCESS;
...
HAL_CAM_Result_en_t CAMDRV_Wakeup(CamSensorSelect_t sensor)
{
	...
	result = Init_zanin_sensor(sensor);
