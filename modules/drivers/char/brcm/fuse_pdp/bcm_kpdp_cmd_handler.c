...
void KPDP_SendResponse(KPDP_CmdList_t *listentry)
{
    ...
    if ( !entry )
    {
        KPDP_DEBUG(DBG_ERROR,"failed to allocate entry buf\n");
        return;
    }
