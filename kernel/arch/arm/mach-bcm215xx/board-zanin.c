...
static struct bcm_keymap newKeymap[] = {
	...
	{BCM_KEY_ROW_6, BCM_KEY_COL_2, "Volume Up", KEY_VOLUMEUP},
	{BCM_KEY_ROW_6, BCM_KEY_COL_3, "Volume Down", KEY_VOLUMEDOWN},
...
#else//zanin rev 0.0
static struct bcm_keymap newKeymap[] = {
	{BCM_KEY_ROW_0, BCM_KEY_COL_0, "P", KEY_P},
	{BCM_KEY_ROW_0, BCM_KEY_COL_1, "O", KEY_O},
	{BCM_KEY_ROW_0, BCM_KEY_COL_2, "I", KEY_I},
	{BCM_KEY_ROW_0, BCM_KEY_COL_3, "U", KEY_U},
	{BCM_KEY_ROW_0, BCM_KEY_COL_4, "Y", KEY_Y},
	{BCM_KEY_ROW_0, BCM_KEY_COL_5, "T", KEY_T},
	{BCM_KEY_ROW_0, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_0, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_1, BCM_KEY_COL_0, "R", KEY_R},
	{BCM_KEY_ROW_1, BCM_KEY_COL_1, "E", KEY_E},
	{BCM_KEY_ROW_1, BCM_KEY_COL_2, "W", KEY_W},
	{BCM_KEY_ROW_1, BCM_KEY_COL_3, "Q", KEY_Q},
	{BCM_KEY_ROW_1, BCM_KEY_COL_4, "key backspace", KEY_BACKSPACE},
	{BCM_KEY_ROW_1, BCM_KEY_COL_5, "L", KEY_L},
	{BCM_KEY_ROW_1, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_1, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_2, BCM_KEY_COL_0, "K", KEY_K},
	{BCM_KEY_ROW_2, BCM_KEY_COL_1, "J", KEY_J},
	{BCM_KEY_ROW_2, BCM_KEY_COL_2, "H", KEY_H},
	{BCM_KEY_ROW_2, BCM_KEY_COL_3, "G", KEY_G},
	{BCM_KEY_ROW_2, BCM_KEY_COL_4, "F", KEY_F},
	{BCM_KEY_ROW_2, BCM_KEY_COL_5, "D", KEY_D},
	{BCM_KEY_ROW_2, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_2, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_3, BCM_KEY_COL_0, "S", KEY_S},
	{BCM_KEY_ROW_3, BCM_KEY_COL_1, "A", KEY_A},
	{BCM_KEY_ROW_3, BCM_KEY_COL_2, "key enter", KEY_ENTER},
	{BCM_KEY_ROW_3, BCM_KEY_COL_3, "key question", KEY_QUESTION},
	{BCM_KEY_ROW_3, BCM_KEY_COL_4, "M", KEY_M},
	{BCM_KEY_ROW_3, BCM_KEY_COL_5, "N", KEY_N},
	{BCM_KEY_ROW_3, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_3, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_4, BCM_KEY_COL_0, "B", KEY_B},
	{BCM_KEY_ROW_4, BCM_KEY_COL_1, "V", KEY_V},
	{BCM_KEY_ROW_4, BCM_KEY_COL_2, "C", KEY_C},
	{BCM_KEY_ROW_4, BCM_KEY_COL_3, "X", KEY_X},
	{BCM_KEY_ROW_4, BCM_KEY_COL_4, "Z", KEY_Z},
	{BCM_KEY_ROW_4, BCM_KEY_COL_5, "key shift", KEY_LEFTSHIFT},
	{BCM_KEY_ROW_4, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_4, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_5, BCM_KEY_COL_0, "key mail", KEY_MAIL},
	{BCM_KEY_ROW_5, BCM_KEY_COL_1, "key mute", KEY_HOMEPAGE},
	{BCM_KEY_ROW_5, BCM_KEY_COL_2, "key dot", KEY_DOT},
	{BCM_KEY_ROW_5, BCM_KEY_COL_3, "key space1", KEY_SPACE},
	{BCM_KEY_ROW_5, BCM_KEY_COL_4, "Volume Down", KEY_VOLUMEDOWN},
	{BCM_KEY_ROW_5, BCM_KEY_COL_5, "0", KEY_0},
	{BCM_KEY_ROW_5, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_5, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_6, BCM_KEY_COL_0, "sym", KEY_CANCEL},
	{BCM_KEY_ROW_6, BCM_KEY_COL_1, "key alt", KEY_RIGHTALT},
	{BCM_KEY_ROW_6, BCM_KEY_COL_2, "unused", 0},
	{BCM_KEY_ROW_6, BCM_KEY_COL_3, "unused", 0},
	{BCM_KEY_ROW_6, BCM_KEY_COL_4, "Volume Up", KEY_VOLUMEUP},
	{BCM_KEY_ROW_6, BCM_KEY_COL_5, "unused", 0},
	{BCM_KEY_ROW_6, BCM_KEY_COL_6, "unused", 0},
	{BCM_KEY_ROW_6, BCM_KEY_COL_7, "unused", 0},
	{BCM_KEY_ROW_7, BCM_KEY_COL_0, "unused", 0},
...
#if defined(CONFIG_LINEAR_POWER)
	// start_charge
	pr_info("%s Start Charging to CTRL GPIO", __func__);
	if(param==PMU_MUIC_CHGTYP_DEDICATED_CHGR)
	{
		gpio_direction_output(CHG_EN,0);
		udelay(50);
		gpio_direction_output(CHG_EN,1);
...
struct d2041_platform_data d2041_pdata = {	
	...
	.regl_map = {
        ...
        D2041_MCTL_MODE_INIT(D2041_LDO_10, 0x66, D2041_REGULATOR_MAX),						// spare
...
#define EXT_CTRL_REQ2	4
	...
	case SYSCFG_SENSORS:
		if(op == SYSCFG_ENABLE){
			...
			/* BIT15 | BIT16 */
			writel(readl(ADDR_SYSCFG_IOCR0) |
				SYSCFG_IOCR0_GPIO55_GPEN10_MUX(0x3), ADDR_SYSCFG_IOCR0);
